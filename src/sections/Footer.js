      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-x border-gray-200/80 relative">
        ...
        <div class="pt-12 sm:pt-14 pb-6 flex flex-col md:flex-row items-center justify-between gap-6 relative z-20 border-b border-gray-100">
          ...
          <div class="flex flex-wrap items-center justify-center gap-5 sm:gap-7 text-xs sm:text-sm font-semibold text-gray-700">
            <a href="tel:+2349033221927" class="inline-flex items-center gap-2 hover:text-[#1D2E9D] transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" class="text-[#EE5A31] shrink-0"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
              <span>(+234) 903322 1927</span>
            </a>
            <a href="mailto:info@schoolpilot.online" class="inline-flex items-center gap-2 hover:text-[#1D2E9D] transition-colors">
              <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" class="text-[#EE5A31] shrink-0"><rect width="20" height="16" x="2" y="4" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
        ...
        <nav class="py-5 flex flex-wrap items-center justify-center gap-6 sm:gap-8 text-xs sm:text-sm font-semibold text-gray-600 relative z-20">
          <a href="/about.html" class="hover:text-[#1D2E9D] transition-colors">About Us</a>
          <a href="/contact.html" class="hover:text-[#1D2E9D] transition-colors">Contact</a>
          <a href="/privacy.html" class="hover:text-[#1D2E9D] transition-colors">Privacy Policy</a>
          <a href="/disclaimer.html" class="hover:text-[#1D2E9D] transition-colors">Disclaimer</a>
          <a href="/terms.html" class="hover:text-[#1D2E9D] transition-colors">Terms & Conditions</a>
        </nav>
        ...
        <div class="relative py-12 sm:py-16 md:py-20 flex flex-col items-center justify-center overflow-hidden select-none">
          ...
          <div class="absolute inset-0 flex items-center justify-center pointer-events-none z-0">
            <span class="text-5xl sm:text-7xl md:text-8xl lg:text-[130px] xl:text-[150px] font-black tracking-wider uppercase leading-none text-center">
              <span class="text-transparent bg-clip-text bg-gradient-to-b from-[#1D2E9D]/20 to-[#1D2E9D]/5">SCHOOL</span><span class="text-transparent bg-clip-text bg-gradient-to-b from-[#EE5A31]/25 to-[#EE5A31]/5">PILOT</span>
            </span>
          </div>
